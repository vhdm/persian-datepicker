...
(function webpackUniversalModuleDefinition(root, factory) {
     ...
     */
                    ...
                    dayPicker: {
                         ...
                         */
                        onSelect: function onSelect(selectedDayUnix, type) {
                            console.log('selectedDayUnix', selectedDayUnix)
                    ...
                    monthPicker: {
                         ...
                         * @param monthIndex
                         */
                        onSelect: function onSelect(monthIndex, type) {
                    ...
                    yearPicker: {
                         ...
                         * @param year
                         */
                        onSelect: function onSelect(year, type) {
                     ...
                     * @param unixDate
                     */
                    onSelect: function onSelect(unixDate, type) {
                        ...
                        },
                        {
                            ...
                            value: function setPickerBoxPosition() {
                                ...
                                if (this.model.options.position === "auto") {
                                    this.$container.css({
                                        left: inputPosition.left + 300 + "px",
                                        top:
                                            inputSize.height +
                                            inputPosition.top +
                                            "px",
